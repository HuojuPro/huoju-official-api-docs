...
Set `account-category` to`cash` for account. 
...
Refer to sample python code to [place order]((https://github.com/HuojuPro/huoju-api-demo/blob/master/python/order_new.py)
